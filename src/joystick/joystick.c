...
void JOYSEL_Callback(void) {
    ...
    // Else if moving wall
        ...
        else { LCD_draw_message((uint8_t *)"INVALID WALL POSITION"); }
    }
...
void JOY_Handle_Movement_Mode(Movement move) {
    ...
    // take 7x7 position
    if (is_player1_turn) curr_pos_player = player1_status.curr_pos;
    else curr_pos_player = player2_status.curr_pos;
    ...
    else if (move == UP_RIGHT) check = check_oblique_movement(matrix_pos_player.i, matrix_pos_player.j, UP_RIGHT);
    else if (move == UP_LEFT) check = check_oblique_movement(matrix_pos_player.i, matrix_pos_player.j, UP_LEFT);
    else if (move == DOWN_RIGHT) check = check_oblique_movement(matrix_pos_player.i, matrix_pos_player.j, DOWN_RIGHT);
    else if (move == DOWN_LEFT) check = check_oblique_movement(matrix_pos_player.i, matrix_pos_player.j, DOWN_LEFT);
    ...
    if (check) {
        ...
        if (move == UP) {
            ...
            if (jump_other_player) wanted_movement_matrix_position.i = curr_pos_player.i - 2;
            else wanted_movement_matrix_position.i = curr_pos_player.i - 1;
            ...
            if (jump_other_player) wanted_movement_matrix_position.j = curr_pos_player.j + 2;
            else wanted_movement_matrix_position.j = curr_pos_player.j + 1;
        }
        else if (move == LEFT) {
