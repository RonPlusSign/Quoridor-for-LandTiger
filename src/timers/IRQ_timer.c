...
void TIMER0_IRQHandler(void) {
    ...
    if (turn_time_left == 0) {
        ...
        if (!is_single_board && is_game_started && ((is_player1_turn && this_board_player_id == PLAYER1) || (!is_player1_turn && this_board_player_id == PLAYER2))) save_skipped_move();
...
/***** TIMER2 *****/
/******************/
void TIMER2_IRQHandler(void) { LPC_TIM2->IR = 1; /* clear interrupt flag */ }


/******************/
/***** TIMER3 *****/
/******************/
void TIMER3_IRQHandler(void) { LPC_TIM3->IR = 1; /* clear interrupt flag */ }
