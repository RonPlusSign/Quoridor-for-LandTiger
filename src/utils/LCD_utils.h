...
#define GRID_BORDER_COLOR DarkGrey
#define WALL_COLOR Black
#define SCREEN_BACKGROUND_COLOR LightBlue
#define ENABLE_MOVEMENTS_COLOR LightYellow
#define WANTED_MOVEMENT_COLOR LightOrange
#define POSSIBLE_WALL_POSITION_COLOR DarkGreen
#define IMPOSSIBLE_WALL_POSITIN_COLOR Red
#define PLAYER1_COLOR White
#define PLAYER2_COLOR Red
#define SELECTED_RECT_MENU DarkGrey
